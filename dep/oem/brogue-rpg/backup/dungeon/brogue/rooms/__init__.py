...
from ..const import LevelProfile
'''
...
def brogue_designRandomRoom(grid: array2d[int], level_profile:LevelProfile ,room_type_frequencies=None, has_doors=True, has_hallway=True, cave_min_width=50, cave_min_height=20):
    '''
    ...
    if f == "brogue_designCrossRoom":
        ...
        brogue_design_cave(grid, cave_min_width, cave_min_height)
    ...
    if has_doors:
        ...
        # 生成走廊
        if has_hallway:
            door_positions = brogue_attachHallwayTo(grid, door_positions, level_profile)
