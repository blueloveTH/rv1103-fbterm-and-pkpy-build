...
from noises.basics.algorithm import advanced_sigmoid, filter_components_by_area
from noises.basics.perlin import Perlin
from noises.basics.voronoi import Voronoi

base_config = {'post_operations': [], 'seed': 123456}



layers_config = [   {   'falloff': 10.23,
        'lacunarity': 0.0,
        'noise_type': 'Voronoi',
        'octaves': 1,
        'operations': [   ('Multiply(x, param)', -2.0),
                          ('Sigmoid(x, param)', 1.0),
                          ('Add(x, param)', -0.12),
                          ('Multiply(x, param)', 2.6),
                          ('Add(x, param)', -0.8),
                          ('Sigmoid(x, param)', 10)
                          ],
        'persistence': 0.0,
